...
class FFTBaseReconstruction(object):
    """
    Base class provides functions for periodic FFT based Reconstructed Power spectrum code.
    Parameters
    ----------
    ...
    def __init__(self, displaced, random, Nmesh, BoxSize):
        ...
        first = _cast_source(displaced, Nmesh=Nmesh, BoxSize=BoxSize)
        second = _cast_source(random, Nmesh=Nmesh, BoxSize=BoxSize)
...
class FFTPowerReconstruction(FFTBaseReconstruction):
    """
    ...
    def __init__(self, displaced, random, mode, Nmesh=None, BoxSize=None,
        ...
        FFTBaseReconstruction.__init__(self, displaced, random, Nmesh, BoxSize)
...
class ProjectedFFTPowerReconstruction(FFTBaseReconstruction):
    """
    ...
    def __init__(self, displaced, random, Nmesh=None, BoxSize=None,
        ...
        assert len(axes) in (1, 2), "length of ``axes`` in ProjectedFFTPowerReconstruction should be 1 or 2"
